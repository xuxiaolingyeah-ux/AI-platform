...
export default function WelcomeMessage({ projectName, onConfirm }: WelcomeMessageProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 px-8 text-center">
      <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 via-blue-500 to-blue-700 flex items-center justify-center mb-5 shadow-xl shadow-blue-500/20">
          ...
          return (
            ...
            >
              <div className={`flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center ${
                isSelected
                  ? 'bg-gradient-to-br from-blue-600 to-blue-500 shadow-md shadow-blue-500/20'
                  : 'bg-gray-100'
              }`}>
      ...
      <button
        ...
        className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-medium rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 text-white hover:from-blue-500 hover:to-blue-400 shadow-lg shadow-blue-500/20 transition-all duration-200"
      >
        开始对话
